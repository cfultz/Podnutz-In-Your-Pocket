...
public class DDG extends Fragment {

    private RecyclerView mRecyclerView;
    private ArticleAdapter mAdapter;
    private SwipeRefreshLayout mSwipeRefreshLayout;
    private ProgressBar progressBar;
    private String urlString = "https://feeds.feedburner.com/podnutz/ddg";
    View mRssView;
    ...
    public void loadFeed() {
        ...
        parser.onFinish(new Parser.OnTaskCompleted() {
            ...
            public void onTaskCompleted(ArrayList<Article> list) {
                ...
                mAdapter = new ArticleAdapter(list, R.layout.row, DDG.this.getActivity());
            ...
            public void onError() {
                ...
                getActivity().runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        progressBar.setVisibility(View.GONE);
                        mSwipeRefreshLayout.setRefreshing(false);
                        Toast.makeText(DDG.this.getActivity(), "Unable to load data. Swipe down to retry.",
